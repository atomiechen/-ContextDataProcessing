...
docker run --gpus all -d -it --name context-jupyter --restart always -p 29503:8888 -v $(pwd)/data:/home/jovyan/work -e GRANT_SUDO=yes -e JUPYTER_ENABLE_LAB=yes -e NOTEBOOK_ARGS="--collaborative" atomie/gpu-jupyter:squash
